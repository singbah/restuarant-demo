...
export default function PostDetails() {
  ...
  function handelComment(e) {
    ...
    setCommentObj((prev) => ({ ...prev, [name]: value }));
  }
  ...
  async function sendComment(e) {
    ...
    try {
      ...
      setMsg({
        title: "Error",
        message:
          "An error occur, we didn't receive your comment please refresh this page and try again",
        status: "error",
        open: true,
      });
    }
      ...
      compo={
        <>
          <Helmet>
            ...
            <meta name="description" content={data.excert} />
