  ...
  return (
    <LayoutScreen
      compo={
        <>
          <Helmet>
            <title>Terms and Conditions | Easi Tech Lr</title>
          ...
          <article className="bg-white rounded-2xl shadow-lg p-6 lg:p-10">
            ...
            <p className="text-gray-500 mb-8">Effective Date: July 7, 2026</p>
            ...
            <section className="mb-8">
              ...
              <p className="leading-8">
                ...
                website performance. You may disable cookies through your
            ...
            <section className="mb-8">
              ...
              <p className="leading-8">
                ...
                you updates, responses, and announcements related to Easi Tech
                Lr. You can unsubscribe from newsletters at any time using the
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold mb-3">7. External Links</h2>
