  ...
  async function fetchBlogs() {
    ...
    try {
      const data = await api.get(
        `/home?cursor=${Number(cursor) || 0}&limit=20`,
      );
      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-b from-black to-blue-500 text-white">
          <div className="max-w-7xl mx-auto px-6 py-20">
            ...
            <p className="mt-4 text-lg md:text-xl max-w-2xl">
              Stay updated with the latest market prices, exchange rates, fuel
              prices, and helpful financial tools for everyday life.
            </p>
        ...
        <section className="max-w-7xl mx-auto px-6 py-12">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-3xl font-bold">Latest Prices</h2>
          ...
          <section className="max-w-7xl mx-auto px-6 py-12">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {blogs &&
                blogs
                  .slice(0, 6)
                  .map((blog) => <PostCard key={blog.id} content={blog} />)}
            </div>
          </section>
        )}
        ...
        {/* Tools */}
        <section className="max-w-7xl mx-auto px-6 py-12">
          <h2 className="text-3xl font-bold mb-8">Financial Tools</h2>
